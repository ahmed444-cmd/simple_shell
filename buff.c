...
/**
 * is_chain - checks if current char in buff is a chain delimeter
...
/**
 * check_chain - checks chaining on last status
 * @info: the param struct
 * @buf: the char buff
 * @p: addr of current pos in buff
 * @i: starting pos in buff
 * @len: length of buff
 *
 * Return: Void
 */
